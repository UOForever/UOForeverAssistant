...
namespace RazorEnhanced
{
	...
	internal class ToolBar
	{
		...
		private static void DrawToolBarBH() // Grande Orizzontale
		{
			...
			int width = Assistant.Properties.Resources.BarraGrandeOrizzontaBordoDestro.Width + Assistant.Properties.Resources.BarraOrizzontaleSpazioStat.Width;
			int offsetstat = 10;
			int paneloffset = 18;


			// Generic Background
			Bitmap tempBackground = Assistant.Properties.Resources.BarraOrizzontaleSpazioStat;
